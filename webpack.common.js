...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ template: './assets/templates/policy.hbs', filename: 'policy.html' }),
    new HtmlWebpackPlugin({ template: './assets/templates/rules.hbs', filename: 'rules.html' }),
  ],

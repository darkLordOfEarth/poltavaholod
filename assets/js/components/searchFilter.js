...
const products = [
  { id:1,  name:"Хумус з грибами",        img:"images/humus.png",         badge:null,          filter:"humus_gryby" },
  { id:2,  name:"Хумус з томатами і базиліком", img:"images/humus_2.png",       badge:null,          filter:"humus_tomat" },
  { id:3,  name:"Пельмені курячі",         img:"images/pelm_chiken.png",   badge:null,          filter:"frozen" },
  { id:4,  name:"вареники з печінкою та серцем",   img:"images/varen_pechin.png",  badge:null,          filter:"frozen" },
  { id:5,  name:"Хінкалі пікантні",     img:"images/hinkali_pic.png",   badge:null,          filter:"frozen" },
  { id:6,  name:'Морозиво пломбір “перлина dubaj”',   img:"images/perl.png",         badge:null,          filter:"icecream", subfilter:"stakanchyk" },
  { id:7,  name:"морозиво манго та малина “mango boom”",    img:"images/mango_boom.png",         badge:"без лактози", filter:"icecream", subfilter:"frukt" },
  { id:8,  name:"Морозиво грейпфрут-смородина",    img:"images/grey.png",         badge:"без лактози", filter:"icecream", subfilter:"frukt" },
  { id:9,  name:'Морозиво пломбір "Золота птаха',  img:"images/ptaha.png",         badge:"без лактози", filter:"icecream", subfilter:"eskimo" },
  { id:10, name:"Нагетси класичні см...",  img:"images/no_image.png",         badge:null,          filter:"napiv" },
  { id:11, name:"Стріпси курячі смаже...", img:"images/no_image.png",         badge:null,          filter:"napiv" },
  { id:12, name:"Закуска бутербродн...",   img:"images/no_image.png",         badge:null,          filter:"zakusky" },
  { id:13, name:"Закуска бутербродн...",   img:"images/no_image.png",         badge:null,          filter:"zakusky" },
  { id:14, name:"Закуска бутербродн...",   img:"images/no_image.png",         badge:null,          filter:"zakusky" },
  { id:15, name:"Закуска бутербродн...",   img:"images/no_image.png",         badge:null,          filter:"zakusky" },
  { id:16, name:"Морозиво ескімо",         img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"eskimo" },
  { id:17, name:"Морозиво ріжок",          img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"rizhky" },
  { id:18, name:"Фруктовий лід",           img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"frukt" },
  { id:19, name:"Вафельний стаканчик",     img:"images/no_image.png",         badge:"Новинка",     filter:"icecream", subfilter:"vafel" },
  { id:20, name:"Ескімо шоколадне",        img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"eskimo" },
  { id:21, name:"Вагове морозиво",         img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"vagove" },
  { id:22, name:"Морозиво у відерку",      img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"vidro" },
  { id:23, name:"Морозиво у лотку",        img:"images/no_image.png",         badge:null,          filter:"icecream", subfilter:"lotok" },
  { id:24, name:"Пельмені свинячі",        img:"images/no_image.png",         badge:null,          filter:"frozen" },
  { id:25, name:"Морозиво пломбір",        img:"images/no_image.png",         badge:"Новинка",     filter:"icecream", subfilter:"rizhky" },
];
...
const tabFilters = {
  ...
  zakusky:  [ { key: "all", label: "Всі продукти" }, { key: "zakusky", label: "Бутербродні" } ],
  napiv:    [ { key: "all", label: "Всі продукти" }, { key: "napiv",   label: "Напівфабрикати" } ],
  frozen:   [ { key: "all", label: "Всі продукти" }, { key: "frozen",  label: "Заморожена" } ],
};
...
function countForFilter(tab, filterKey) {
  ...
  return getTabProducts(tab).filter(p =>
    (p.subfilter && p.subfilter === filterKey) || (!p.subfilter && p.filter === filterKey)
  ).length;
}
...
function renderFilters() {
  ...
  filters.forEach(f => {
    ...
    const btn = $(`<button class="filter-item${isActive}" data-filter="${f.key}">${f.label}${countHtml}</button>`);

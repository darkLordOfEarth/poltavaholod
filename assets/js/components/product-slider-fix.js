...
//             const withOutVideo = container.querySelector('.product__slider-image-no-video');
//             if (hasVideo || withOutVideo) {
...
//                 const hasVideo = container.querySelector('.product__slider-video');
//                 const noHasVideo = container.querySelector('.product__slider-image-no-video');
                
//                 if (hasVideo || noHasVideo) {
...
//                     const imageWithoutVideo = container.querySelector('.product__slider-image-no-video');

$(function () {
  ...
  function setFancyThumbsBtn() {
    ...
    $('body').append(`
      <button class="fancyThumbBtn">
        <svg xmlns="https://www.w3.org/2000/svg" width="14" height="8" viewBox="0 0 14 8" fill="none">
  ...
  document.addEventListener('fancybox:init', () => setTimeout(setFancyThumbsBtn, 300));
  document.addEventListener('fancybox:ready', () => setTimeout(setFancyThumbsBtn, 300));
  ...
  // КЛИК ПО КАРТИНКЕ
  // -------------------------------------------------------
  $(document).on('click', '.product__slider-images .gallery-item', function (e) {
    e.preventDefault();
    e.stopPropagation();

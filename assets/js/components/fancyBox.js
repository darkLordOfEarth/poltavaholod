...
//     const $playBtn = $block.find('.play__btn');
//     const $closeBtn = $block.find('.videoBlock__close');
//     const $fancyboxLink = $block.find('.video-fancybox-trigger');

//     if (!$video.length) return;

//     // ============================
//     // КЛИК ПО PLAY → ОТКРЫВАЕМ FANCYBOX
//     // ============================
//     $playBtn.off('click').on('click', function (e) {
//       e.preventDefault();
//       e.stopPropagation();
//       Fancybox.show([{ src: $fancyboxLink.attr('href'), type: "video" }]);

//     });

//     // ============================
//     // КЛИК ПО ВИДЕО → Тоже Fancybox
//     // ============================
...
//     // ============================
//     // КНОПКА CLOSE → Просто закрывает локальное состояние
//     // ============================
//     $closeBtn.off('click').on('click', function () {
//       $video[0].pause();
//       $block.removeClass('open');
...
//     // ============================
//     // ОТКЛЮЧАЕМ ВОСПРОИЗВЕДЕНИЕ ВНУТРИ СЛАЙДА
//     // ============================
//     $video[0].pause();
//     $block.removeClass('open');
//     $playBtn.show();
